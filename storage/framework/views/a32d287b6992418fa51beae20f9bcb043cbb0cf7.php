        ...
        <div class="bg-gd-dusk">
            <div class="hero-static content content-full bg-white invisible" data-toggle="appear">
                ...
                <div class="py-30 px-5 text-center">
                    ...
                    <h1 class="h2 font-w700 mt-50 mb-10">Welcome to Your Portal</h1>
                ...
                <div class="row justify-content-center px-5">
                    <div class="col-sm-8 col-md-6 col-xl-4">
                        <form class="js-validation-signin" role="form" method="POST" action="<?php echo e(url('/admin/login')); ?>">
                          <?php echo e(csrf_field()); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-material floating ">
                                     ...
                                     <?php if($errors->has('username')): ?>
                                        <div class="invalid-feedback"><strong><?php echo e($errors->first('username')); ?></strong></div>
                                     <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row gutters-tiny">
                                ...
                                <div class="col-sm-12 mb-10">
                                    <a class="btn btn-block btn-noborder btn-rounded btn-alt-secondary" href="<?php echo e(url('/admin/forgotpassword')); ?>">
