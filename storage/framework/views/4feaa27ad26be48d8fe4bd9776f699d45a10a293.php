    ...
    <div class="bg-image bg-image-bottom" style="background-image: url(<?php echo e(asset("images/photos/photo13@2x.jpg")); ?>);">
        <div class="bg-primary-dark-op py-30">
            <div class="content content-full text-center">
                ...
                <a class="btn btn-rounded btn-hero btn-sm btn-alt-primary mb-5" href="<?php echo e(url('/admin/editprofile')); ?>">
            ...
            <div class="block-content">
                ...
                <div class="row justify-content-center py-20">
                    <div class="col-xl-6">
                        ...
                        <form class="js-validation-bootstrap" action="<?php echo e(url('/admin/changepass')); ?>" method="post" novalidate="novalidate">
                            <?php echo e(csrf_field()); ?>

                            <div class="form-group row <?php echo e($errors->has('currentpass') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if($errors->has('currentpass')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('currentpass')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group row <?php echo e($errors->has('newpass') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if($errors->has('newpass')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('newpass')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group row <?php echo e($errors->has('newpass_confirmation') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if($errors->has('newpass_confirmation')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('newpass_confirmation')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
