    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Add New <?php echo e($title); ?></h3>
            ...
            <div class="block-content">
                ...
                <div class="row justify-content-center py-20">
                    <div class="col-xl-10">
                        ...
                        <form class="js-validation-bootstrap" action="<?php echo e(url('/admin/relationshipmanager')); ?>" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group row <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="name" name="name" placeholder="Enter name" value="<?php echo e(old('name')); ?>" type="text">
                            ...
                            <div class="form-group row <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="email" name="email" placeholder="Enter email" value="<?php echo e(old('email')); ?>" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row <?php echo e($errors->has('phone') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="phone" name="phone" placeholder="Enter phone no" value="<?php echo e(old('phone')); ?>" type="text" required onkeypress='return (event.charCode >= 46 && event.charCode <= 57) || event.keyCode == 8 || event.keyCode == 9' maxlength="12" minlength="10">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
							...
							<div class="form-group row <?php echo e($errors->has('rm_code') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="rm_code" name="rm_code" placeholder="Enter unique RM Code" value="<?php echo e(old('rm_code')); ?>" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row <?php echo e($errors->has('username') ? 'is-invalid' : ''); ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="username" name="username" placeholder="Enter username" value="<?php echo e(old('username')); ?>" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <label class="css-control css-control-sm css-control-success css-switch">
                                        <input name="status" type="checkbox" class="css-control-input" checked>
