    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Add New {{ $title }}</h3>
            ...
            <div class="block-content">
                ...
                <div class="row justify-content-center py-20">
                    <div class="col-xl-10">
                        ...
                        <form class="js-validation-bootstrap" action="{{ url('/admin/relationshipmanager') }}" method="post" novalidate="novalidate">
                            {{ csrf_field() }}
                            <div class="form-group row {{ $errors->has('name') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="name" name="name" placeholder="Enter name" value="{{ old('name') }}" type="text">
                            ...
                            <div class="form-group row {{ $errors->has('email') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="email" name="email" placeholder="Enter email" value="{{ old('email') }}" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row {{ $errors->has('phone') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="phone" name="phone" placeholder="Enter phone no" value="{{ old('phone') }}" type="text" required onkeypress='return (event.charCode >= 46 && event.charCode <= 57) || event.keyCode == 8 || event.keyCode == 9' maxlength="12" minlength="10">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
							...
							<div class="form-group row {{ $errors->has('rm_code') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="rm_code" name="rm_code" placeholder="Enter unique RM Code" value="{{ old('rm_code') }}" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row {{ $errors->has('username') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input class="form-control" id="username" name="username" placeholder="Enter username" value="{{ old('username') }}" type="text">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
